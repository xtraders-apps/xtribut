          ...
          <header className="mb-12 flex justify-between items-start relative stagger-in no-print" style={{ '--stagger-index': 0 } as React.CSSProperties}>
            <div className="flex items-center gap-4">
              ...
              <div className="page-title">
                <h1 className="text-2xl font-regular text-text-primary">MDT</h1>
                <h5 className="text-1xl font-regular text-text-primary">Sistema de Tributação Mercado Americano</h5>
              </div>
            </div>
            <button
